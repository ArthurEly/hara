...
def main():
    ...
    parser.add_argument('--importance', type=str, default='no', help='Feature importance or not')
    ...
    # train = train.drop(columns=['Repo', 'NodeName', 'SRLs', 'Logic LUTs', 'LUTRAMs','binaryXnorMode'])
    # test = test.drop(columns=['Repo', 'NodeName', 'SRLs', 'Logic LUTs', 'LUTRAMs','binaryXnorMode'])
    ...
    if args.importance == 'yes':
        ...
        plot_cumulative_feature_importance(multioutput_model, X_train.columns, y_train.columns)
    ...
    if args.tuning == 'no':
        ...
        output_base_path = "spot_checking_results_xnor/"
