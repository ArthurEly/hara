...
def main():
    ...
    parser.add_argument(
        ...
        help="ID da topologia do modelo (ex: 'A', 'B')."
    )
    parser.add_argument(
    ...
    hardware_explorer = HardwareExplorer(
        ...
        # Estas configs devem ser carregadas de 'config.py' dentro da classe HardwareExplorer
        # Ex: from config import BUILD_CONFIG, MAX_RESOURCES, HARA_LOOP_CONFIG
        config=None, # Ajuste na classe HardwareExplorer
        resource_limits=None, # Ajuste na classe HardwareExplorer
        hara_loop_config=None # Ajuste na classe HardwareExplorer
    )
